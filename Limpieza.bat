...
chcp 65001
rem **********************************************************************************************
echo Edición 2.3, Basada en el borrador de temporales del mismo autor con diferente seudónimo
rem **********************************************************************************************
rem Partimos de la base 2.3 de TEMPv2.3.bat
echo Este script limpiará los archivos temporales y cachés de las aplicaciones más comunes.
...
echo ******************AHORA Ctrl+C PARA INTERRUMPIR LA EJECUCIÓN DE ESTE SCRIPT*******************
echo **********************************************************************************************
